...
public class PlayerController_wave : MonoBehaviour
{
    ...
    GameController_wave gameController;
    float hueValue;
    ...
    void Awake()
    {
        ...
        gameController = GameObject.Find("Game Controller").GetComponent<GameController_wave>();
    }
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        {
            SoundManager_wave.instance.PlaySingle(deathSound);
            // SoundManager.instance.musicSource.Stop(); // Stops the music
            Death();
        }
        else if (other.gameObject.tag == "Collectible")
        {
            SoundManager_wave.instance.PlaySingle(itemSound);
            GetItem(other);
        }
    }
    ...
    void Death()
    {
        ...
        StartCoroutine(Camera.main.gameObject.GetComponent<CameraShake_wave>().Shake());
